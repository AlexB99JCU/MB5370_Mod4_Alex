...
data <- read.csv('/Users/alexanderbarkley/Downloads/assignment 1 mod 4 dataset.csv', skip = 1)  # Skipping first row
view(data)
...
ggplot(df_long, aes(x = Distance, y = Semivariance, color = Season)) +
  ...
  geom_smooth(method = "loess", span = 0.5, se = FALSE) +  # Explicitly use LOESS, using non-parametric regression method used to smooth data trends in scatter plots 
  theme_minimal() +
...
```
The graph is inverted because I labelled the y axis wrong
